  ...
  >
    ...
    <div className="md:col-span-6 flex flex-col md:flex-row items-end gap-x-4 gap-y-4">
      ...
      <div className="w-full relative">
        <label htmlFor="from" className="block text-sm font-bold text-gray-800 text-left">
          Source
        </label>
        <input
          type="text"
          ...
          placeholder="Source"
          className={`mt-1 block w-full p-2 sm:p-3 text-sm sm:text-base bg-white text-gray-900 border-0 border-b-2 ${
        ...
        {fromSuggestions.length > 0 && (
          <div className="absolute z-10 w-full bg-white shadow-lg mt-1 rounded-none max-h-60 overflow-y-auto">
            {fromSuggestions.map((airport) => (
              <div
                key={airport.code}
                className="p-3 text-gray-900 cursor-pointer border-0 border-red-600 hover:bg-red-100 hover:border-l-4"
      ...
      {/* Destination */}
      <div className="w-full relative">
        <label htmlFor="to" className="block text-sm font-bold text-gray-800 text-left">
          Destination
        </label>
        <input
          type="text"
    ...
    <div className={tripType === "oneWay" ? "md:col-span-3" : "md:col-span-2"}>
      <label htmlFor="depart-date" className="block text-sm font-bold text-gray-800 text-left">
        Depart Date
      </label>
      <ArkDatePicker
        id="depart-date"
    ...
    {tripType === "roundTrip" && (
      <div className="md:col-span-2">
        <label htmlFor="return-date" className="block text-sm font-bold text-gray-800 text-left">
          Return
        </label>
        <ArkDatePicker
          id="return-date"
    ...
    >
      <label htmlFor="passengers" className="block text-sm font-bold text-gray-800 text-left">
        Passengers
      </label>
      ...
      <div className="relative">
        ...
        >
          <span className={adults + children === 0 ? "text-gray-400" : "text-gray-900"}>
            {getPassengerText()}
          </span>
          <ChevronDown
            className={`h-4 w-4 text-gray-700 transition-transform ${isPassengerDropdownOpen ? "rotate-180" : ""}`}
          />
        </button>
